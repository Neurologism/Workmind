...
def call(self, operation: dict) -> None:
    self.project_data[operation["uid"]] = keras.layers.LSTMCell(
        units=operation["args"]["units"],
        activation=(operation["args"]["activation"] if "activation" in operation["args"] else "tanh"),
        recurrent_activation=(operation["args"]["recurrent_activation"] if "recurrent_activation" in operation["args"] else "sigmoid"),
