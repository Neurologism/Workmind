...
def call(self, operation: dict) -> None:
    self.project_data[operation["uid"]] = keras.layers.RandomTranslation(
        height_factor=operation["args"]["height_factor"],
        width_factor=operation["args"]["width_factor"],
        fill_mode=(operation["args"]["fill_mode"] if "fill_mode" in operation["args"] else "reflect"),
