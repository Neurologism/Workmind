...
def call(self, operation: dict) -> None:
    self.project_data[operation["uid"]] = keras.layers.IntegerLookup(
        ...
        oov_token=(operation["args"]["oov_token"] if "oov_token" in operation["args"] else -1),
        vocabulary=(self.project_data[operation["args"]["vocabulary"]] if "vocabulary" in operation["args"] else None),
        vocabulary_dtype=(operation["args"]["vocabulary_dtype"] if "vocabulary_dtype" in operation["args"] else "int64"),
