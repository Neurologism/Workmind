...
def call(self, operation: dict) -> None:
    self.project_data[operation["uid"]] = keras.layers.Resizing(
        ...
        crop_to_aspect_ratio=(
            operation["args"]["crop_to_aspect_ratio"]
            if "crop_to_aspect_ratio" in operation["args"]
            else False
        ),
        pad_to_aspect_ratio=(
            operation["args"]["pad_to_aspect_ratio"]
            if "pad_to_aspect_ratio" in operation["args"]
            else False
        ),
        fill_mode=(
